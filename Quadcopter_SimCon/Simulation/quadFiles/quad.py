...
#excel_path = "output.xlsx"  # Change this to your actual file path
...
class Quadcopter:
    ...
    def state_dot(self, t, state, cmd, wind):
        ...
        TorM4 = torque[3]
        #endTime = time.time()
        #print("Simulated in {:.6f}s.".format(endTime - startTime))
    ...
    def update(self, t, Ts, cmd, wind):
        ...
        #self.acc[0] = self.acc[0]+50*sin(t)
        scale = 1000000        
        p = p+50*np.sin(2*3.14*24500*t/scale)
        #q = (q+50*np.sin(t))
        #r = (r+50*np.sin(t))
        #pdb.set_trace()
        #print("First Values:" )
